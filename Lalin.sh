...
echo -e $white"             ============================================="
echo -e $white"             %                                           %"
echo -e $white"             % $cyan           LAZY "$red"LINUX$cyan TOOLKIT $red v1.5 $white      %"
...
echo
echo
select lalinselc in "Update Kali" "Virtual Machine" "Browsers" "WiFu" "Exploit-db" "Sniffing&MITM" "Firefox Security Toolkit" "HackPack" "HID Attack Payload" "BACKDOOR" "Lazynmap" "Exploit Development" "Start Services" "Fixing all problem" "DECRYTPTER & ENCRYPTER" "Credits" "Exit"; do
case $lalinselc in
	"Update Kali")
		updatekali
		clear ;;
