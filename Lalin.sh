...
echo -e $white"             ============================================="
echo -e $white"             %                                           %"
echo -e $white"             % $cyan           LAZY "$red"LINUX$cyan TOOLKIT $red v1.6 $white      %"
...
echo -e $white"             % $cyan  	 Changelog: $red 19-06-2016   	$white %"
echo -e $white"             %                                           %"
echo -e $white"             ============================================="
echo
echo
echo -e $white""	
select lalinselc in "Update Kali" "Virtual Machine" "Browsers" "WiFu" "Exploit-db" "Sniffing&MITM" "Firefox Security Toolkit" "HackPack" "HID Attack Payload" "BACKDOOR" "Lazynmap" "Exploit Development" "Start Services" "Fixing all problem" "DECRYTPTER & ENCRYPTER" "LazyMacchanger" "Credits" "Exit"; do
case $lalinselc in
	"Update Kali")
		updatekali
		clear ;;
